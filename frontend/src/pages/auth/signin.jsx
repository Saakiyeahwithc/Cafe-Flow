...
return(
    <div className="bg-black min-h-screen flex items-center justify-center opacity-[0.9]">
      <div className="bg-[#FFF8F1] p-8 rounded-2xl shadow-lg w-100 h-140 overflow-auto text-start">
        ...
        <p className='font-medium text-sm mb-3 text-gray-600'>Note: Every field with * is required</p>
