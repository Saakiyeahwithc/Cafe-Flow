  ...
  return (
    <div className="flex flex-wrap gap-5">
      {tables.length === 0 ? (
        ...
        [...tables]
          .sort((t1, t2) => t1.table_number - t2.table_number)
          .map((table) => (
...
`}
              ...
              <div
                className={`absolute top-25 -left-6 select-none z-50
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/40 z-50">
          <div className="bg-white p-5 rounded-xl shadow-lg text-center h-40 w-80 flex flex-col items-center justify-center">
            <p className="font-medium text-lg mb-6">
              Really want to delete Table {deletePopup.table_number}?
            </p>
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                onClick={() => {
                  deleteTable(deletePopup.table_id);
                  setDeletePopup(null);
                }}
