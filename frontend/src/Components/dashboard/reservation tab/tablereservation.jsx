...
function TableReservations({
  ...
  const handleAssign = (reservation) => {
    assignTable(reservation.table_reservation_id);
  };
    ...
    <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-slate-200 mb-6">
          ...
          <table className="min-w-full table-auto">
            ...
            <tbody>
              {filteredData.map((reservation, index) => (
                <tr
                  key={reservation.table_reservation_id}
                ...
                >
                  ...
                  <td className="px-6 py-3 text-gray-600 text-sm">
                    {reservation.type === "walk_in" ? "Walk in" : "Reservation"}
                  </td>
                  <td className="px-6 py-3 text-gray-600 text-sm">
          ...
          <div className="bg-white p-7 rounded-xl shadow-lg text-center w-100 flex flex-col items-center justify-center">
            <p className="font-medium text-lg mb-6">
              ...
              <span className="font-bold">
                {selectedTable.guest?.full_name ?? "this guest"}
              </span>{" "}
              from the system?
            </p>
            <div className="flex items-center justify-center gap-4">
              ...
              <button
                onClick={() => {
                  setPopUp(false);
                  deleteTableReservation(selectedTable.table_reservation_id);
                }}
      ...
      {showFilter && (
        <Filter
          ...
          nameField="table_reservation.guest.full_name"
